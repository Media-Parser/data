...
# 상대 경로 설정
input_path = os.path.normpath(os.path.join(base_dir, "../../dirty/data/merged_202501.jsonl"))
output_path = os.path.normpath(os.path.join(base_dir, "../data/cleaned_202501.jsonl"))
